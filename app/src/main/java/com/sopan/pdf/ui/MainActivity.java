...
import com.sopan.pdf.FileUtils;
import com.sopan.pdf.R;
import com.sopan.pdf.permission.PermissionsActivity;
import com.sopan.pdf.permission.PermissionsChecker;

import java.io.File;
import java.io.FileOutputStream;
import java.io.IOException;

import static com.sopan.pdf.LogUtils.LOGE;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createPdf(FileUtils.getAppPath(mContext) + "order_book.pdf");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checker.lacksPermissions(PermissionsChecker.REQUIRED_PERMISSION)) {
                    PermissionsActivity.startActivityForResult(MainActivity.this, PermissionsActivity.PERMISSION_REQUEST_CODE, PermissionsChecker.REQUIRED_PERMISSION);
                } else {
                    createPdf(FileUtils.getAppPath(mContext) + "order_book.pdf");
                }
            }
    ...
    public void createPdf(String dest) {
        ...
        try {
            ...
            document.addAuthor("@Sopan");
            document.addCreator("Sopan Ahmed");
            ...
            Chunk mOrderIdValueChunk = new Chunk("#123548", mOrderIdValueFont);
            ...
            Chunk mOrderDateValueChunk = new Chunk("15/08/2016", mOrderDateValueFont);
            ...
            Chunk mOrderAcNameValueChunk = new Chunk("Sopan Ahmed", mOrderAcNameValueFont);
            Paragraph mOrderAcNameValueParagraph = new Paragraph(mOrderAcNameValueChunk);
            document.add(mOrderAcNameValueParagraph);

           /* document.add(new Paragraph(R.string.sample_paragraph));
            document.add(new Chunk(lineSeparator));
            document.add(new Paragraph(R.string.sample_paragraph));*/
            ...
            Toast.makeText(mContext, "Pdf file Created... :)" + dest, Toast.LENGTH_SHORT).show();
